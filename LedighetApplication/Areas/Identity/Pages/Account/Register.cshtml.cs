    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            try
            {
                ...
                DepartmentSelectList = new SelectList(departments, "DepartmentId", "Name");
            }
            catch (Exception ex)
            {
                // Log or handle the exception
                // Consider what to do if departments can't be loaded
            }
        }
        private async Task<int> GetDefaultDepartmentId()
        {
            var defaultDepartment = await _context.Departments
                .Where(d => d.Name == "Not Chosen")
                .FirstOrDefaultAsync();
            return defaultDepartment?.DepartmentId ?? 1;  //makes standard chsoee if user hasent chsoen 
        }
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.DepartmentId = Input.DepartmentId ?? await GetDefaultDepartmentId();
